...
def skills_system_prompt(enabled_names=None):
    ...
    parts = [
        ...
        "",
        "SKILLS vs TOOLS:",
        "- Skills are structured workflows that may involve scripts, web calls, or multi-step processes.",
        "- Tools are for general-purpose operations (file I/O, git, web search, HTTP requests, etc.).",
        "- When a skill matches the user's request (by trigger or description), ALWAYS use the skill instead of tools.",
        "- Use tools only when no skill matches the user's intent.",
        "",
        "Available skills:",
        "",
    ]
